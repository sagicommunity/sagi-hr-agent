...
// 2026-09-08, по указанию Sagi: убрал из чек-листа пункты common1/common2/common3/common5
// и sales2/sales4/sales5/sales7/sales8/sales9/sales10/sales11 — «в принципе не нужны».
// Не трогаем ключи в api/resources.js (VALID_KEYS) — если там были прикреплены ссылки
// на эти пункты, они просто перестают где-либо отображаться, но не теряются.
const ITEMS = {
  common: [
  ...
  sales: [
    ...
    ['sales6', 'Видео-встречи с клиентами — обязательно ЖИВЫЕ видеозвонки (не просто просмотр видео-примеров). Обязательно посмотреть видео-примеры от Малека, Кати, Павла и Асель — остальные видео от менеджеров по желанию. Как назначать и проводить демо — Zoom / Google Meet'],
  ],
  success: [
