...
export default async function handler(req, res) {
  ...
  try {
    ...
    // когда реально приглашён (message === inviteTextSales): у success/support нет трека обучения
    // на hr.sagibonus.com, с ними связываются в WhatsApp, кнопка туда была бы некуда вести.
