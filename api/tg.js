...
// Приглашение на стажировку сразу после заявки (2026-08-17, по указанию Sagi «так и всем») —
// та же философия, что и на hh.kz: не держим в подвешенном «рассмотрим и свяжемся». НО только
// для вакансий продаж (sales/sales_remote) — программа обучения на hr.sagibonus.com сейчас вся
// заточена под продажи (скрипты звонков, работа с возражениями, продукт), для техподдержки
// такой программы пока нет, приглашать туда было бы нечестно. Для техподдержки и явного «Отказ»
// оставляем прежнее «рассмотрим и свяжемся» — тут это правда, автоматики после заявки нет.
